...
export const AlbumTitle = styled.h2`margin: 8px 0 4px; color: ${({ theme }) => theme.colors.text}; font-family: ${({ theme }) => theme.fonts.heading}; font-size: clamp(28px, 5vw, 44px);`;
...
export const Description = styled.p`color: #aaaabc; font-size: 14px; line-height: 1.7; white-space: pre-line;`;
